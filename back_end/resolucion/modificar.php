...
<form id="formulario" role="form" action="actualiza.php" method="POST">
    ...
    <input type="text" hidden="hidden" value="<?php echo $_GET["id"]; ?>" name="id">
	<div class="form-group">
	<label for="numero">Número</label>
    <input type="text" name="numero" id="numero" value="<?php echo $_GET["numero"]?>"class="form-control" pattern="[0-9]{2,4}/[0-9]{2,4}" required/>
	<label for="fecha">Fecha</label>
    <input type="date" name="fecha" id="fecha" min="01/01/1971" max="12/11/2021"  value="<?php echo $_GET["fecha"]?>"class="form-control"  required/>
    ...
    <input type="text" name="url" id="url" value="<?php echo $_GET["url"];?>" pattern="[h][t][t][p][:][/][/][a-z/.-]{2,64}[.][p][d][f]" class="form-control" placeholder="http://ejemplo.com" required>
</div>
