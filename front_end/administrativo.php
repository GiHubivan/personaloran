...
<body>
    <div id="cuerpo">
        <header>
            <h1 class=" titulo ">Administrativo de Personal</h1>
            <div class="perfil">
        ...
        <div class=" nav-bg ">
            <nav class=" navegacion-principal contenedor ">
                <a href=" # ">Inicio</a>
                <a href="/personaloran/back_end/resolucion/index.php">Resoluciones</a>
                
                <a href="/personaloran/back_end/designaciones/index.php">Designaciones</a>
                <a href=" # ">Docentes</a>
                <a href="/personaloran/back_end/persona/index.php">Personas</a>
            </nav>
        </div>
